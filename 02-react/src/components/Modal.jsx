...
export default function Modal({ setBooks, isModalOpen, setIsModalOpen, selectedBook }) {
    ...
    const handleEdit = (event) => {
        ...
        const updatedBook = {
            title: modalData.get("modal-title"),
            author: modalData.get("modal-author"),
            status: modalData.get("modal-status"),
            genre: modalData.get("modal-genre"),
            notes: modalData.get("modal-notes")
        }

        // Actualiza las propiedades del libro editado y no modifica el resto de libros
        setBooks(prevBooks => {
