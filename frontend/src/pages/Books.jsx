...
import { createBook, updateBook, deleteBook } from '../services/booksApi.js'
...
export default function Books() {
    ...
    const handleSaveBook = async (bookData) => {
        if (selectedBook) {
            const response = await updateBook(selectedBook.id, bookData)
            setBooks(prevBooks =>
                prevBooks.map(book => book.id === selectedBook.id ? response.data : book)
            )
        } else {
