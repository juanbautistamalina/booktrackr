...
export default function Modal({ isModalOpen, selectedBook, onSaveBook, onDeleteBook, onCloseModal }) {
    ...
    const [imagePreview, setImagePreview] = useState(selectedBook?.image || "/books/default.jpg")
    const [fileName, setFileName] = useState("Ninguna imagen seleccionada")

    useEffect(() => {
        setImagePreview(selectedBook?.image || "/books/default.jpg")
            ...
            <div className={styles.modalContent}>
                ...
                <div className={styles.modalBody}>
                    <div className={styles.imageContainer}>
                        <img src={imagePreview} alt={`Portada del libro ${title}`} />
